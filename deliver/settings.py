...
SECRET_KEY = 'django-insecure-n$)b&+29jg0!t0t-mv%$nfqldzfz^^(&u$+)$ht#s=3#!3g+ni'
...
JAZZMIN_SETTINGS = {
    'site_title': "Meal Scout | Admin",
    'site_header': "Meal Scout",
    'site_brand': "Meal Scout",
    'site_logo': "/assets/img/Logo1.png",
    'login_logo': "/assets/img/MiniLogo.png",
    'site_icon': None,
    'welcome_sign': "Sign In",
    'copyright': "Meal Scout",
